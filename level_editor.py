...
blob_img = pygame.image.load('Images/img/blob.png')
platform_x_img = pygame.image.load('Images/img/platform_x.png')
platform_y_img = pygame.image.load('Images/img/platform_y.png')
lava_img = pygame.image.load('Images/img/lava.png')
coin_img = pygame.image.load('Images/img/coin.png')
exit_img = pygame.image.load('Images/img/exit.png')
save_img = pygame.image.load('Images/img/save_btn.png')
load_img = pygame.image.load('Images/img/load_btn.png')
		...
		for col in range(20):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 2:
					...
					screen.blit(img, (col * tile_size - main.scroll[0], row * tile_size - main.scroll[1]))
				if world_data[row][col] == 3:
					#enemy blocks
					img = pygame.transform.scale(blob_img, (tile_size, int(tile_size * 0.75)))
					screen.blit(img, (col * tile_size - main.scroll[0], row * tile_size + (tile_size * 0.25) - main.scroll[1]))
				...
				if world_data[row][col] == 6:
					...
					screen.blit(img, (col * tile_size - main.scroll[0], row * tile_size + (tile_size // 2) - main.scroll[1]))
				if world_data[row][col] == 7:
					#coin
					img = pygame.transform.scale(coin_img, (tile_size // 2, tile_size // 2))
					screen.blit(img, (col * tile_size + (tile_size // 4) - main.scroll[0], row * tile_size + (tile_size // 4) - main.scroll[1]))
